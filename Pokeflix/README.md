...
Apreendi muitas coisas na criação desse projeto como usar as variaveis para aplicar as cores padrão e já estou aplicando em um projeto de comunidade que participo e até repacei a ideia para os outros membros, também foi ótimo ver como o Instrutor Felipe Aguiar @felipeAguiarCode, passa as dicas de procurar as imagens do NEtflix no google e assim poder ter uma visão mais clara do que esta construindo, essa dica é otima para quem não é design e quer continuar treinando a criação de interfaces.
